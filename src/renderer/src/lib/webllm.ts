...
export const WEBLLM_MODELS = [
    {
        ...
        name: 'Gemma 4 2B (Lightweight)',
        description: 'New fast on-device model from Google, excellent for general chat',
        size: '~1.5GB',
        vram: '~2GB',
        requiredRamGB: 4,
        requiredVramGB: 2,
    ...
    },
    {
        ...
        name: 'Gemma 4 9B (Advanced)',
        description: 'High performance on-device model for complex reasoning',
        size: '~5.5GB',
        vram: '~6.5GB',
        requiredRamGB: 8,
        requiredVramGB: 6.5,
