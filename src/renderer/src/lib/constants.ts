...
export const VOICE_CONFIG = {
    ...
    VOSK_MODELS: [
        { id: 'en-us', name: 'English (US)', modelName: 'vosk-model-small-en-us-0.15', locale: 'en-US' },
        { id: 'en-in', name: 'English (India)', modelName: 'vosk-model-small-en-in-0.4', locale: 'en-IN' },
        { id: 'zh-cn', name: 'Mandarin (Chinese)', modelName: 'vosk-model-small-cn-0.22', locale: 'zh-CN' },
        { id: 'ja', name: 'Japanese', modelName: 'vosk-model-small-ja-0.22', locale: 'ja-JP' },
        { id: 'fr', name: 'French', modelName: 'vosk-model-small-fr-0.22', locale: 'fr-FR' },
        { id: 'de', name: 'German', modelName: 'vosk-model-small-de-0.15', locale: 'de-DE' },
        { id: 'es', name: 'Spanish', modelName: 'vosk-model-small-es-0.42', locale: 'es-ES' },
        { id: 'it', name: 'Italian', modelName: 'vosk-model-small-it-0.22', locale: 'it-IT' },
        { id: 'hi', name: 'Hindi', modelName: 'vosk-model-small-hi-0.22', locale: 'hi-IN' },
    ] as VoskModel[]
}
