                ...
                if (browserRuntime) {
                    ...
                    setProviderStatus({
                        ollama: {
                            ...
                            models: ollama.success ? (ollama.models || [ollamaSettings.model]) : [],
                            ...(ollama.success ? {} : { error: ollama.error || 'Ollama is not responding' }),
                        },
                        openai: {
                            available: openai.success && openai.exists,
                            model: settings.openaiModel,
                            models: openai.success && openai.exists ? [settings.openaiModel] : [],
                        ...
                        gemini: {
                            ...
                            models: gemini.success ? (gemini.models || [settings.geminiModel]) : [],
                        ...
                        openrouter: {
                            ...
                            models: openrouter.success && openrouter.exists ? [settings.openrouterModel] : [],
                            modelsEndpointAvailable: false,
