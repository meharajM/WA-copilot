...
| Email | Gmail project verification and mailbox authorization | Send a threaded reply, bounce, attachment, revoked-token and restart cases | Thread headers are preserved; bounces are ignored; attachments escalate; revoked auth pauses processing; queued mail recovers | Message IDs/logs |
