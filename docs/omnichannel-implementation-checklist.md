...
- [ ] Measure correctness, missed/unnecessary escalation, latency, editing time, recovery time and cost per resolved conversation. (Supervisor now persists owner quality labels for correct, incorrect, unnecessary-escalation and missed-escalation decisions, and exposes review accuracy/escalation precision alongside grounding, latency, draft editing, delivery-unknown and cost metrics; recovery-time drills and provider-authoritative metrics remain.)
