...
- [ ] Build evaluation cases for common, missing, contradictory, multilingual, follow-up, sensitive, injection and account-specific questions. (Focused policy coverage now includes sensitive, injection, unsupported multilingual and account-specific cases; common/missing/contradictory/follow-up quality fixtures remain.)
- [ ] Measure correctness, missed/unnecessary escalation, latency, editing time, recovery time and cost per resolved conversation. (Supervisor now exposes bounded-window inbound/outcome totals and average decision latency alongside durable estimated usage/cost; correctness, editing, recovery and provider-authoritative metrics remain.)
