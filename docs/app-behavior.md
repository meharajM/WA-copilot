...
- With a connected Baileys session or configured Cloud transport, selecting supported files in the browser and sending them delivers bounded media with an optional first-file caption; any file over 8 MiB, unsafe names/MIME values, missing credentials, or disconnected sessions fail closed.
